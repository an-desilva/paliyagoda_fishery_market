<?php
// views/reports/lorry_expenses.php
// Lorry Offloading Freight & Helper Batta Cash Disbursement Audit Log
...
<div class="space-y-6">
    ...
    <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-slate-900 p-6 rounded-2xl border border-slate-800 shadow-lg">
        <div>
            <h1 class="text-2xl font-black text-white tracking-tight flex items-center gap-2">
                ...
                <span>Lorry Freight & Helper Batta Disbursement Log</span>
            </h1>
            <p class="text-xs text-slate-400 mt-1">
                Cash disbursements audit for Helper Batta (ගෝලයාගේ බටා), lorry freight expenses, and coolie handling fees.
            </p>
        </div>
    </div>
    ...
    <div class="grid grid-cols-1 sm:grid-cols-3 gap-5">
        <div class="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-xl">
            <div class="text-xs font-bold text-amber-400 uppercase">Total Helper Batta Cash Paid</div>
            <div class="text-2xl font-black text-amber-400 mt-1"><?= formatLKR($totalBatta) ?></div>
            <div class="text-[11px] text-slate-400 mt-1">Instant Cash Advances Issued</div>
        </div>
        ...
        <div class="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-xl">
            ...
            <div class="text-[11px] text-slate-400 mt-1">Inward Harbor Transport</div>
        </div>

        <div class="bg-slate-900 p-5 rounded-2xl border border-slate-800 shadow-xl">
            <div class="text-xs font-bold text-slate-400 uppercase">Total Coolie Handling</div>
            <div class="text-2xl font-black text-cyan-400 mt-1"><?= formatLKR($totalCoolie) ?></div>
            <div class="text-[11px] text-slate-400 mt-1">Market Floor Offloading</div>
        </div>
    </div>
